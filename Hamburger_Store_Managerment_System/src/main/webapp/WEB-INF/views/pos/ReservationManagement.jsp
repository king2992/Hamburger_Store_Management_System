            ...
            $(document).ready(function(){
              ...
              //소켓 서버로 부터 send_msg를 통해 이벤트를 받을 경우 
                socket.on('send_msg', function(msg) {
                    ...
                    $('<div></div>').text(''+userId+' : '+ msg).appendTo("#chat_box");
                });
            });
        </script>
...
<div id="page" class="container">
	<div id="header">
		...
		<div id="menu"> 
			<ul>
				<li><a href="/pos/OrderManagement" accesskey="1" title="">Order Management</a></li>
				<li class="current_page_item"><a href="/pos/ReservationManagement" accesskey="2" title="">Reservation Management</a></li>
