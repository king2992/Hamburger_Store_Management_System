...
#menu_wrap .option{text-align: center; position: relative; left:0; top:0; z-index:10; transition: left 0.5s; transform:translateX(0px); transition-duration:200ms;}
...
function removeAllChildNods(el) {   
 ...
 function storeMove(title){
	 location.href="/takeOutReservation/takeOutUserReservation?places="+title+"";
 }
</script>
</body>
</html>