...
<body>
 <div>
	...
	<form name="signUp" action="/user/signUp" method="post">
		<span>ID : <button type="button" onClick="idCk()" class="btn btn-primary">중복체크</button><input type="text" name="userId" id="userId" value=""> </span>
		<span>PW : <input type="text" name="userPassword" id="userPassword" value=""></span>
	</form>
			<button type="button" onClick="signUpGoData()"  class="btn btn-primary btn-block btn-large">회원가입</button>
	</div> 
</div> 
</body> 
