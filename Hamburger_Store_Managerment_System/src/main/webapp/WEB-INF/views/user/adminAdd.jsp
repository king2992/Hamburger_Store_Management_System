...
<body>
 	<div><h2>관리자 회원가입</h2></div>
 	<div><span>아이디 : <input type="text"><button type="button">중복체크</button></span></div>
 	<div><span>비밀번호 : <input type="password"></span></div>
 	<div><span>이름 : <input type="text"></span></div>
