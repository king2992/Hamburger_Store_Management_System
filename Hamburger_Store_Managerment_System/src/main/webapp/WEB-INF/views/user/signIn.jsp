...
<div class="login">
<h1>로그인</h1>
<form  action="/user/signIn" method="POST" name="signIn">
    <input type="text" placeholder="Username"name="userId" id="userId" autofocus/>
    <input type="password" placeholder="Password" name="userPassword" id="userPassword"/>
 <button type="button" onClick="Login()" class="btn btn-primary btn-block btn-large">로그인</button> 
 </form>
