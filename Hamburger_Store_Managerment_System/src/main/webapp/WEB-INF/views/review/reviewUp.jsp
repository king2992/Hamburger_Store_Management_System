...
<input type="hidden" id="number" name="number" value="${reviewUp.number}">
                <span>제목</span> <input type="text" name="title" id="board_subjecttext" value="${reviewUp.title}">
            </div>
            <div class="board_writesubbottom">
                <span>욕설, 도배, 비방 루머등 운영정책에 어긋나는 게시물 등록시에는 이용 제한 등 불이익을 받으실 수 있습니다.</span>
            </div>
        </div>
        <textarea id="summernote" name="contents"  style="resize: none;">${reviewUp.contents}</textarea>
